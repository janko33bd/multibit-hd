 ...
 *         
 */
public class CryptocoinsSwingIcon implements Icon, PropertyChangeListener {

  private JComponent component;

  private String text;

  private Font font = CryptoCoinsDecorator.CRYPTOCOINS_FONT;
   ...
   */
  public CryptocoinsSwingIcon(JComponent component, Character text) {
   ...
   */
  public CryptocoinsSwingIcon(JComponent component, Character text, boolean enabled) {
   ...
   */
  public CryptocoinsSwingIcon(JComponent component, Character text, int size) {
   ...
   * @param enabled   True if the icon should be enabled, false for a more faded style
   */
  public CryptocoinsSwingIcon(JComponent component, Character text, int size, boolean enabled) {
